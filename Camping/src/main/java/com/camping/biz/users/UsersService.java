...
public interface UsersService {
	// DAO占쎈쐻占쎈짗占쎌굲占쎈쐻占쎈짗占쎌굲 占쎈쐻占쎈짗占쎌굲筌ｏ옙 Users id 占쎈쐻占쎈솭占쎈툡占쎌뒻占쎌굲占쎈쐻占쎈짗占쎌굲 - >
	// 占쎈쐻占쎈짗占쎌굲占쎈쐻占쎈짗占쎌굲占쎈쐻占쎈짗占쎌굲 Impl占쎈쐻占쎈짗占쎌굲占쎈쐻占쎈짗占쎌굲
	...
	public void findPwd(HttpServletResponse response, UsersVO vo) throws IOException; // 占쎈쐻占쎈짗占쎌굲占쎈쐻占쎈뼓占쎈쿈占쎌굲/占쎈쐻占쎈뼓筌뤿슣�굲占쎈쐻占쎈짗占쎌굲
																						// 占쎈쐻占쎈짗占쎌굲占쎌돳 占쎈쐻占쎈뼣占쎌뒻占쎌굲
																						// 占쎈쐻占쎈셽占쎈뻻�뇡�빘�굲�뎲�꼪�쐻占쎈뼍�뜝占�
																						// 占쎈쐻占쎈짗占쎌굲占쎈쐻占쎈짗占쎌굲
