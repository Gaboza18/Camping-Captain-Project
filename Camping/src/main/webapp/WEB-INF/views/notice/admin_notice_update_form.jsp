...
<body>
	<div align="center">
			<article>
				<h2>회원 공지사항 수정</h2>
				<form name="formm" method="get" id="admin_manage_notice_update" action="admin_manage_notice_update">
					<fieldset>
					...
					<input type="button" value="수정하기" class="submit" onclick="notice_update_chk()">
